...
anxious_ppg_queue_2 = queue.Queue()  # Queue for Anxious Calibration PPG data
anxious_eda_queue_2 = queue.Queue()  # Queue for Anxious Calibration EDA data
anxious_ppg_queue_3 = queue.Queue()  # Queue for Anxious Calibration PPG data
anxious_eda_queue_3 = queue.Queue()  # Queue for Anxious Calibration EDA data
...
anxious_calibration_value_2 = 0
anxious_calibration_value_3 = 0
...
anxious_calibration_done_2 = False
anxious_calibration_done_3 = False

# Global variables for baselines
calm_baseline_hrv = None
anxious_baseline_hrv = None
anxious_baseline_hrv_2 = None
anxious_baseline_hrv_3 = None
...
def index():
    ...
    global calm_calibration_done, anxious_calibration_done, anxious_calibration_done_2, anxious_calibration_done_3, state
    global calm_baseline_hrv, anxious_baseline_hrv, anxious_baseline_hrv_2, anxious_baseline_hrv_3
    results = get_analysis_results()
    game_flags_values = [calm_calibration_value, anxious_calibration_value, anxious_calibration_value_2, anxious_calibration_value_3, data_analysis_value, ability_value]
    calibration_done = [calm_calibration_done, anxious_calibration_done, anxious_calibration_done_2, anxious_calibration_done_3]
    baselines = [calm_baseline_hrv, anxious_baseline_hrv, anxious_baseline_hrv_2, anxious_baseline_hrv_3]
...
def game_flags():
    global calm_calibration_value, anxious_calibration_value, anxious_calibration_value_2, anxious_calibration_value_3, data_analysis_value, ability_value
    if request.method == 'POST':
        if request.is_json:
            data = request.get_json()
            calm_calibration_value = data.get('CalmCalib', 0)
            anxious_calibration_value = data.get('StressedCalib', 0)
            anxious_calibration_value_2 = data.get('StressedCalib2', 0)
            anxious_calibration_value_3 = data.get('StressedCalib3', 0)
        ...
        return jsonify(
            ...
            anxious_calibration_value_2=anxious_calibration_value_2,
            anxious_calibration_value_3=anxious_calibration_value_3,
...
def handle_state_changes():
    ...
    while not stop_event.is_set():
        ...
        elif anxious_calibration_value_2 == 1 and state == "ANXIOUS_CALIBRATION" and anxious_calibration_done == True:
            state = "ANXIOUS_CALIBRATION_2"
            print("State changed to ANXIOUS_CALIBRATION_2")

        elif anxious_calibration_value_3 == 1 and state == "ANXIOUS_CALIBRATION_2" and anxious_calibration_done_2 == True:
            state = "ANXIOUS_CALIBRATION_3"
            print("State changed to ANXIOUS_CALIBRATION_3")

        elif data_analysis_value == 1 and state == "ANXIOUS_CALIBRATION_3" and anxious_calibration_done_3 == True:
            state = "DATA_ANALYSIS"
...
def measurements_handler(address, *args):
    ...
    elif state == "ANXIOUS_CALIBRATION_2":
        if "PPG:GRN" in address:
            for arg in args:
                anxious_ppg_queue_2.put(arg)
        elif "EDA" in address:
            for arg in args:
                anxious_eda_queue_2.put(arg)

    elif state == "ANXIOUS_CALIBRATION_3":
        if "PPG:GRN" in address:
            for arg in args:
                anxious_ppg_queue_3.put(arg)
        elif "EDA" in address:
            for arg in args:
                anxious_eda_queue_3.put(arg)
...
def run_anxious_calibration_2():
    global anxious_baseline_hrv_2, anxious_calibration_value_2, general_start_time, anxious_calibration_done_2
    while not stop_event.is_set():
        if state == "ANXIOUS_CALIBRATION_2":
            if general_start_time == None:
                print("Error fetching general logging starting time. Press Ctrl+C to shut down the server.")
                break
            anxious_baseline_hrv_2 = anxious_calibration(anxious_ppg_queue_2, anxious_eda_queue_2, stop_event, general_start_time)
            anxious_calibration_value_2 = 0
            anxious_calibration_done_2 = True
            if anxious_baseline_hrv_2 == 0:
                print("Error during anxious calibration. Press Ctrl+C to shut down the server.")
                break
            print(f"Anxious calibration 2 completed. Anxious Baseline 2: {anxious_baseline_hrv_2}")
            break
        threading.Event().wait(0.1)

def run_anxious_calibration_3():
    global anxious_baseline_hrv_3, anxious_calibration_value_3, general_start_time, anxious_calibration_done_3
    while not stop_event.is_set():
        if state == "ANXIOUS_CALIBRATION_3":
            if general_start_time == None:
                print("Error fetching general logging starting time. Press Ctrl+C to shut down the server.")
                break
            anxious_baseline_hrv_3 = anxious_calibration(anxious_ppg_queue_3, anxious_eda_queue_3, stop_event, general_start_time)
            anxious_calibration_value_3 = 0
            anxious_calibration_done_3 = True
            if anxious_baseline_hrv_3 == 0:
                print("Error during anxious calibration 3. Press Ctrl+C to shut down the server.")
                break
            print(f"Anxious calibration completed. Anxious Baseline 3: {anxious_baseline_hrv_3}")
            break
        threading.Event().wait(0.1)
...
def main():
    ...
    anxious_thread_2 = threading.Thread(target=run_anxious_calibration_2)
    anxious_thread_3 = threading.Thread(target=run_anxious_calibration_3)
    ...
    anxious_thread_2.start()
    anxious_thread_3.start()
    ...
    calm_thread.join()
    anxious_thread.join()
    anxious_thread_2.join()
    anxious_thread_3.join()
